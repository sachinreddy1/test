 ...
 * {@link TimelineView.ViewHolder#itemView} and {@link ItemTouchUIUtil} makes necessary changes
...
public interface ItemTouchUIUtil {
     ...
     * TimelineView, TimelineView.ViewHolder, float, float, int, boolean)}
     */
    void onDraw(Canvas c, TimelineView recyclerView, View view,
     ...
     * TimelineView, TimelineView.ViewHolder, float, float, int, boolean)}
     */
    void onDrawOver(Canvas c, TimelineView recyclerView, View view,
                    float dX, float dY, int actionState, boolean isCurrentlyActive);

    /**
     * The default implementation for {@link ItemTouchHelper.Callback#clearView(TimelineView,
     * TimelineView.ViewHolder)}
     */
    void clearView(View view);

    /**
     * The default implementation for {@link ItemTouchHelper.Callback#onSelectedChanged(
     * TimelineView.ViewHolder, int)}
     */
